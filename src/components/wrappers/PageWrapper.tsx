...
const PageWrapper = (data: PageWrapperProps) => {
  return (
      ...
      <div className="flex w-full  flex-col items-center gap-10 justify-start  lg:flex-row lg:justify-between lg:gap-20 lg:mt-[125px] lg:items-start lg:px-[134px] lg:py-[122px]">
